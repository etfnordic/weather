(() => {
  ...
  const COLOR_STOPS = [
  // -40 .. -30 (rosa)
  { t: 0.00,   r: 255, g: 31,  b: 143 }, // -40 intensiv rosa  (#ff1f8f)
  { t: 0.125,  r: 255, g: 95,  b: 162 }, // -30 rosa          (#ff5fa2)

  // -30 .. -20 .. -10 .. -5 (blåskala)
  { t: 0.25,   r: 11,  g: 26,  b: 74  }, // -20 marinblå      (#0b1a4a)
  { t: 0.375,  r: 18,  g: 60,  b: 156 }, // -10 mörkare blå   (#123c9c)
  { t: 0.4375, r: 59,  g: 130, b: 246 }, // -5 blå            (#3b82f6)

  // 0 (grönt)
  { t: 0.50,   r: 34,  g: 197, b: 94  }, // 0 grönt           (#22c55e)

  // 10 .. 20 .. 30 .. 40 (varmt)
  { t: 0.625,  r: 132, g: 204, b: 22  }, // 10 grön-gul       (#84cc16)
  { t: 0.75,   r: 250, g: 204, b: 21  }, // 20 gul            (#facc15)
  { t: 0.875,  r: 251, g: 146, b: 60  }, // 30 orange         (#fb923c)
  { t: 1.00,   r: 127, g: 29,  b: 29  }, // 40 vinrött        (#7f1d1d)
];
